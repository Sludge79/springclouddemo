package sludge.redis.interceptor;

/**
 * @Author Giggles
 * @Date 2019-10-25 9:45 AM
 */
...
import sludge.redis.annotation.CacheLock;
...
public class LockMethodInterceptor {
    ...
    @Around("execution(public * *(..)) && @annotation(sludge.redis.annotation.CacheLock)")
